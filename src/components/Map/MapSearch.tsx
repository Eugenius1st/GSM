...
//     residence?: MapDataType;
//     setResidence?: (value: MapDataType) => void;
// }

// export default function MapSearch({ setResidence }: MapSearchType) {
...
//         mapRender();
//     };
//     const selectOneKeyword = (data: any) => {
...
//                         <div className="mt-2">{markers}검색 결과가 없습니다</div>
//                     </div>
//                 )}
//             </div>
//         </Map>

...
function EnhancedTableHead(props: EnhancedTableProps) {
  ...
  const createSortHandler =
    (property: keyof RowDataType) => (event: React.MouseEvent<unknown>) => {
      onRequestSort(event, property);
    };

  return (
    <TableHead
      sx={{ ".MuiTableCell-root": { background: egPurple.superLight } }}
    >
      <TableRow>
        ...
        <TableCell sx={{ paddingX: 0 }} align="center">
          정보 보기
        </TableCell>
        <TableCell sx={{ paddingX: 0 }} align="center">
          수업 보기
                    ...
                    >
                      ...
                      <TableCell sx={{ paddingX: 0 }} align="center">
                        <Link to={`/admin/coach/${row._id}`}>
                          <WhiteBtn content="정보보기" width="18" />
                        </Link>
                      </TableCell>
                      <TableCell sx={{ paddingX: 0 }} align="center">
                        <Link to={`/admin/coach/coach-class/${row._id}`}>
                          <WhiteBtn content="수업보기" width="18" />
                        </Link>
                      </TableCell>
                    </TableRow>
                  );

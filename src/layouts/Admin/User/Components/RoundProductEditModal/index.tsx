...
const RoundProductEditModal = ({ flag, setFlag, defaultInfo }: RoundProductEditModalType) => {
    ...
    const [newRPStartDate, setNewRPStartDate] = useState(defaultInfo.startOfSales);
    ...
    return (
        <div>
            <div onClick={handleShowModal}>
                <button className="flex items-center p-1 font-bold text-egPurple-default hover:bg-egPurple-semiLight hover:text-egWhite-default">
                    <div>수정</div>
                    <MdEdit />
                </button>
            </div>

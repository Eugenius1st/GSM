                                            ...
                                            className={
                                                isMobile
                                                    ? round.available && round.use
                                                        ? roundAvailableMobileStyle
                                                        : roundDisAvailableMobileStyle
                                                    : round.available && round.use
                                                    ? roundAvailableStyle
                                                    : roundDisAvailableStyle
                                            }
                                        >
